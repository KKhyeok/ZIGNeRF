...
class CheckpointIO(object):
    ...
    '''        
        ...
        scalars = {k: v for k, v in state_dict.items()     # state_dict {epoch_it, it, loss_val_best, model, optimizer, optimizer_d, optimizer_i}
                   if k not in self.module_dict}            # self.module_dict { model, optimizer, optimizer_d, optimizer_i}
        return scalars
