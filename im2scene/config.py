...
# Trainer
def get_trainer(model, optimizer, optimizer_d, optimizer_i, cfg, device):
    ...
    trainer = method_dict[method].config.get_trainer(
        model, optimizer, optimizer_d, optimizer_i, cfg, device)
    return trainer
...
def get_dataset(cfg, **kwargs):
    ...
    if cfg['rendering']['mode'] == 'test' or cfg['rendering']['mode'] == 'interpolate' :
        dataset_folder = cfg['data']['test_path']
    else:
    ...
    if dataset_name == 'lsun':
        ...
        dataset = data.ImagesDatasetCond(
